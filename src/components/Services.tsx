    ...
    <section className="container px-4 py-24 sm:py-32">
      <div className="grid lg:grid-cols-[1fr,1fr] gap-8 place-items-center">
        <div>
          ...
          <p className="mt-4 mb-8 text-base text-muted-foreground sm:text-lg lg:text-xl">
          ...
          <div className="flex flex-col gap-8">
            {rolesList.map(({ icon, title, description }: RoleProps) => (
              <Card key={title} className="hover:shadow-lg transition">
                <CardHeader className="flex flex-col items-start justify-start gap-4 space-y-1 sm:flex-row">
        ...
        <img
          src={rolesImage}
          className="w-full max-w-xs object-contain md:max-w-md lg:max-w-[600px]"
